  ...
  return (
    <div className="flex h-40 shrink-0 flex-col border-t bg-background">
      <div className="flex items-center gap-2 border-b px-4 py-2">
        ...
        <p className="text-[13px] font-medium">Speaker notes</p>
      ...
      {slide ? (
        <Textarea
          ...
          placeholder={`Notes for slide ${idx + 1}…`}
          aria-label={`Notes for slide ${idx + 1}`}
        ...
        <p className="px-4 py-3 text-sm text-muted-foreground">No slide selected.</p>
      )}
    </div>
  )
}
      ...
      <header className="flex h-14 shrink-0 items-center gap-1.5 border-b px-2 sm:px-3">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              aria-label={deckStarred ? "Remove star" : "Add star"}
          ...
          <TooltipContent side="bottom" className="text-xs">
            {deckStarred ? "Remove star" : "Add star"}
          </TooltipContent>
        </Tooltip>
        ...
        <div className="ml-auto flex items-center gap-1.5">
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom" className="text-xs">
              Present from this slide (Ctrl+Enter)
            </TooltipContent>
          </Tooltip>
        </div>
      </header>
