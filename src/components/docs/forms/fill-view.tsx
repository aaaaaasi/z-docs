      ...
      <div className="flex min-h-screen flex-col bg-muted/40">
        ...
        <main className="mx-auto flex w-full max-w-3xl flex-1 items-center justify-center px-4 py-10">
          ...
          >
            ...
            <h1 className="text-xl font-normal">Your response has been recorded</h1>
            <p className="max-w-sm text-[13px] text-muted-foreground">
              Thanks for filling out “{form.title.trim() || "Untitled form"}”.
            </p>
  ...
  return (
    <div className="flex min-h-screen flex-col bg-muted/40">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 space-y-4 px-4 py-8 sm:px-6 sm:py-10">
        ...
        <div className="pt-2">
          <p className="text-[13px] text-muted-foreground">Never submit passwords through Z-Forms.</p>
          <div className="mt-3 flex items-center gap-3">
            <Button onClick={handleSubmit} disabled={submitting} className="h-10 min-w-32" aria-label="Submit response">
