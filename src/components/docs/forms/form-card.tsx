      ...
      <div className="flex flex-1 flex-col gap-1 p-3">
        ...
        <div className="mt-auto flex items-center justify-between gap-1 pt-1.5">
          <p className="min-w-0 truncate text-[12px] text-muted-foreground/80 tnum">
            {f.responseCount} response{f.responseCount === 1 ? "" : "s"} · edited {relativeTime(f.updatedAt)}
          </p>
          <div className="flex shrink-0 items-center">
            <Button
              ...
              aria-label={f.starred ? `Unstar ${f.title}` : `Star ${f.title}`}
                ...
                {p.tab !== "trashed" ? (
                  <>
                    ...
                    <DropdownMenuItem onClick={p.onToggleStar}>
                      ...
                      {f.starred ? "Remove star" : "Add star"}
                    </DropdownMenuItem>
